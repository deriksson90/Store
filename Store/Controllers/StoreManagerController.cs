...
namespace shoppingstore.Controllers
{
    ...
    public class StoreManagerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemId,CategoryId,ProducerId,Title,Price")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemId, CategoryId, ProducerId, Title, Price, Weight, Volume, Fragile, InstHelp, Category, Producer, OrderDetails, Order")] Item item)
        {
            if (ModelState.IsValid)
            {
